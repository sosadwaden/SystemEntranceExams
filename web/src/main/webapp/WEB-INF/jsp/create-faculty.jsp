...
<html>
<head>
    <title>Создание факультета</title>
...
<body>
    ...
    <form action="${pageContext.request.contextPath}/create-faculty" method="post" enctype="multipart/form-data">
        ...
        <label for="faculty_capacity">
            <input type="text" name="faculty_capacity" id="faculty_capacity" value="${param.faculty_capacity}" required>
        </label>
        <br>
        <span>Описание факультета:</span>
        <br>
        <label for="description">
            <textarea name="description" id="description" cols="65" rows="10" value="${param.description}" required></textarea>
        </label>
        <br>
